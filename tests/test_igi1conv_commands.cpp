...
TEST_F(IGI1ConvTest, MefExportVFlipMatchesModelType) {
    ...
    //                              "Still Face of Bone Models are
    //                              flipped upside down when exported"
    //                              bug the user keeps reporting)
...
//   - The user reported that bone model *faces* are still upside-down
//     when exported to .obj or .mef ("Exporting Bone model objects to
//     .obj or .mef flips their face upside down").  The current rule
//     is therefore:
//        modelType 0 (rigid)    -> V flipped
//        modelType 1 (bone)     -> V flipped (face textures would be
...
//                            upside-down otherwise - the bug the
...
TEST_F(IGI1ConvTest, MefExportVFlip_Type1_Bone_FlipsV) {
    ...
    // land in OpenGL convention.  The user reported: "Still Face of
    // Bone Models are flipped upside down when exported" - the
    // face appears upside down unless V is flipped for bone models.
